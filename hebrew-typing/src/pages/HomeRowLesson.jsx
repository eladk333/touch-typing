...
<p style={{ color: "#456",fontSize: "1.2rem", lineHeight: "1.8" }}>
  העיקרון הראשון בהקלדה עיוורת הוא תמיד להחזיר את האצבעות אל
  <b> שורת הבית</b> כשאינך מקליד/ה. שורת הבית היא נקודת הייחוס שממנה
  תלמד/י את המיקום של כל שאר המקשים. ברוב המקלדות יש בליטות קטנות על
  המקשים <b>כ</b> ו-<b>ח</b> שמסייעות לאתר את שורת הבית בלי להביט על
  המקלדת.
</p>
      

      <h2 style={{ color: "#246", margin: "24px 0 8px" }}>יד ימין</h2>
        <h3 style={{ color: "#246", margin: "24px 0 8px" }}>מנח נכון של היד</h3>
      <p>יש למקם את יד ימין כך שהאצבע המורה מונחת על  <b>ח</b>, האמה מונחת על <b>ל</b>, הקמיצה מונחת על <b>ך</b> והזרת מונחת על <b>ף</b>. </p>
      <p>היד צריכה להיות מורמת מעט מעל המקלדת, כשהאצבעות קמורות כלפי מטה ומצביעות ישירות אל המקשים. כך יהיה קל יותר להזיז את האצבעות בלי להזיז את הידיים. מומלץ לעצור רגע ולמקם נכון את יד ימין לפני שממשיכים. חשוב מאוד לפתח הרגלים טובים כבר בתחילת תרגול ההקלדה.</p>
